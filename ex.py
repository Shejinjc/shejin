...
df = pd.read_csv('ts&ccex.csv',delimiter=';',index_col='date')
...
df_newDates = pd.read_csv('datess.csv',delimiter=';',index_col='date')
...
new_predictions_series.to_csv("predicted_sales9.csv")
